                                            ...
                                            .map((bank, index) => (
                                                <tr key={index}>
                                                    ...
                                                    <td className="py-1 border-b">
                                                        {bank.logo ? (
                                                            <img className="w-12 h-12 rounded object-cover" src={`http://itrbru.thddns.net:6440/images/bank/logo/${bank.logo}`} alt="" />
                                                        ) : (
                                                            <img className="w-12 h-12 rounded object-cover" src="http://itrbru.thddns.net:6440/images/product/No_image.png" alt="No Image" />
                                                        )}
                                                    </td>

                                                    <td className="py-1 border-b">
                                                        {bank.image ? (
                                                            <img className="w-12 h-18 rounded object-cover" src={`http://itrbru.thddns.net:6440/images/bank/${bank.image}`} alt="" />
                                                        ) : (
                                            ...
                                            <div className="mx-auto" key={index}>
                                                <Link to={`/bank/${bank.id}`}> {/* ใส่ URL ที่เหมาะสม */}
                                                    <div className="relative overflow-hidden rounded-lg group">
                                                        ...
                                                        {bank.image ? (
                                                            <img className="object-cover" src={`http://itrbru.thddns.net:6440/images/bank/${bank.image}`} alt="" />
                                                        ) : (
                                                            <img className="object-cover" src="http://itrbru.thddns.net:6440/images/bank/no_image.png" alt="No Image" />
                                                        )}
                                                        <div className="absolute top-1 left-1">
                                                        {bank.logo ? (
                                                            <img className="w-24 h-24 rounded-lg object-cover" src={`http://itrbru.thddns.net:6440/images/bank/${bank.logo}`} alt="" />
                                                        ) : (
                                                            <img className="w-24 h-24 rounded-lg object-cover" src="http://itrbru.thddns.net:6440/images/bank/no_image.png" alt="No Image" />
                                                        )}
                                                        </div>
                                                    </div>
                                                </Link>
