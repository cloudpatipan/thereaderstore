      ...
      {loading ? (
        ...
        <div className="border p-4 rounded">
          ...
          <div className="w-[10rem] h-[14rem] overflow-hidden rounded-lg">
            {order.payment_image ? (
              <img className="rounded object-cover" src={`http://itrbru.thddns.net:6440/images/payment_image/${order.payment_image}`} alt="" />
            ) : (
              <img className="rounded object-cover" src="http://itrbru.thddns.net:6440/images/product/no_image.png" alt="No Image" />
            )}
          </div>
