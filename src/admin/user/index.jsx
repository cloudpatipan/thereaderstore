                                            ...
                                            displayedUsers.map((user, index) => (
                                                <div className="mx-auto" key={index}>
                                                    <div className="relative overflow-hidden rounded-lg group">
                                                        ...
                                                        {user.avatar ? (
                                                            <img className="object-cover" src={`http://itrbru.thddns.net:6440/images/avatar/${user.avatar}`} alt="" />
                                                        ) : (
                                                            <img className="object-cover" src="http://itrbru.thddns.net:6440/images/no_image.png" alt="No Image" />
                                                        )}
                                                    </div>
